...
func GetAllLogs(c *gin.Context) {
	...
	logs, total, err := model.GetAllLogs(logType, startTimestamp, endTimestamp, modelName, username, tokenName, (p-1)*pageSize, pageSize, channel, requestIP, c.GetString("request_id"))
	if err != nil {
