...
import { Button, Card, Col, Form, Layout, Row, Spin, Descriptions, Tabs } from '@douyinfe/semi-ui';
...
const Detail = (props) => {
  ...
  return (
    <>
      <Layout>
        {
          props.currentPage === 'dashboard' ? <></> : <Layout.Header>
            <h3>{t('数据看板')}</h3>
          </Layout.Header>
        }
        <Layout.Content>
          {
            props.currentPage === 'dashboard' ? <></> :
                <Form ref={formRef} layout='horizontal' style={{ marginTop: 20, marginBottom: 20 }}>
                  <>
                    <Form.DatePicker
          ...
          <Spin spinning={loading}>
            <Row gutter={[{ xs: 16, sm: 16, md: 16, lg: 24, xl: 24, xxl: 24 }, 24]} type="flex" justify="space-between">
              {
                props.currentPage === 'dashboard' ? <></> :
              ...
              <Col span={isMobile?24: props.currentPage === 'dashboard' ? 12: 12}>
                <Card>
                  <Descriptions row size="small">
