...
const EditChannel = (props) => {
  ...
  useEffect(() => {
    ...
    if (inputs.models.length) {
      if (!inputs.test_model) {
        setInputs((inputs) => ({ ...inputs, test_model: localModelOptions[0] }));
      }
    }
          ...
          <Form layout={'vertical'}>
            ...
            {inputs.type === 3 && (
              <>
                ...
                <Form.Item label={'AZURE_OPENAI_ENDPOINT'}>
                  <Input
                ...
                <Form.Item label={'默认API版本'}>
                  <Input
                    label="默认API版本"
                    name="azure_other"
                    placeholder={
                      '请输入默认API版本，例如：2023-06-01-preview，该配置可以被实际的请求查询参数所覆盖'
                    }
                    onChange={(e) => {
              ...
              <Space direction="vertical" style={{ width: '100%' }}>
                ...
                <Space.Compact style={{ width: '100%' }}>
                  <Input
                    ...
                    value={customModel}
                    onChange={(e) => {
                      setCustomModel(e.target.value.trim());
                    }}
                  />
            ...
            <Form.Item label={'组织'}>
              <Input
                ...
                onChange={(e) => {
                  handleInputChange('openai_organization', e.target.value);
                }}
                value={inputs.openai_organization}
              />
            </Form.Item>
            {!!inputs.models.length && (
              <Form.Item label={'默认测试模型'}>
                <Select
                  name="test_model"
