...
const OperationSetting = () => {
      ...
      data.forEach((item) => {
        if (item.key === 'ModelRatio' || item.key === 'GroupRatio' || item.key === 'ModelPrice') {
          if (item.key === 'ModelPrice') {
            setModelPriceList(
              Object.entries(JSON.parse(item.value)).map((item) => {
                return {
                  key: item[0],
                  value: item[1],
                };
  ...
  const handleModelPriceChange = (e, row, rowIndex, key) => {
    ...
    const modelPrice = JSON.stringify(
            ...
            <Col span={8}>
              <Card title={'固定价格'}>
                <Form.Group widths="equal">
                  ...
                  {/*            borderless*/}
                  {/*            defaultValue={text}*/}
                  {/*            onKeyPress={(e) => handleModelPriceChange(e, record, index, 'key')}*/}
                  {/*          ></Input>*/}
                  {/*        );*/}
                  {/*      },*/}
                  {/*    },*/}
                  ...
                  {/*          <Input*/}
                  {/*            defaultValue={text}*/}
                  {/*            onKeyPress={(e) => handleModelPriceChange(e, record, index, 'value')}*/}
                  {/*          ></Input>*/}
                  {/*        );*/}
                  {/*      },*/}
                  {/*    },*/}
