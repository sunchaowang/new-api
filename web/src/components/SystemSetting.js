...
const SystemSetting = () => {
  ...
  const submitPayAddress = async () => {
    ...
    if (inputs.TopUpRate !== undefined && inputs.TopUpRate !== '') {
      await updateOption('TopUpRate', inputs.TopUpRate);
    }
    ...
    <Grid columns={1}>
      <Grid.Column>
        <Form loading={loading} inverted={isDark}>
          ...
          <Header as="h3" inverted={isDark}>
            代理设置（支持{' '}
            <a href="https://github.com/Calcium-Ion/new-api-worker" target="_blank" rel="noreferrer">
              new-api-worker
            </a>
            ）
          </Header>
          ...
          <Form.Group widths="equal">
            <Form.Input
              ...
              onChange={handleInputChange}
            />
            <Form.Input label="易支付商户ID" placeholder="例如：0001" value={inputs.EpayId} name="EpayId" onChange={handleInputChange} />
            <Form.Input
              label="易支付商户密钥"
          ...
          <Form.Group widths="equal">
            <Form.Input
                label="充值费率"
                placeholder="例如：0.01，就是1%费率"
                value={inputs.TopUpRate}
                name="TopUpRate"
                min={0}
                onChange={handleInputChange}
            />
          ...
          <Message>
            ...
            ，Authorization callback URL 填 <code>{`${inputs.ServerAddress}/oauth/github`}</code>
          </Message>
          <Form.Group widths={3}>
            <Form.Input
          ...
          <Divider />
          <Header as="h3" inverted={isDark}>
            配置 Linux Do OAuth App
            <Header.Subheader>
              用以支持通过 Linux Do 进行登录注册，
              <a href="https://github.com/settings/developers" target="_blank" rel="noreferrer">
                点击此处
              </a>
              管理你的 Linux Do OAuth App
            </Header.Subheader>
          </Header>
          <Form.Group widths={3}>
            <Form.Input
              ...
              placeholder="输入 Linux Do OAuth APP 的 ID"
            />
            <Form.Input
          ...
          <Header as="h3" inverted={isDark}>
            ...
            <Header.Subheader>
              用以支持通过微信进行登录注册，
              <a href="https://github.com/songquanpeng/wechat-server" target="_blank" rel="noreferrer">
                点击此处
              </a>
              了解 WeChat Server
            </Header.Subheader>
          ...
          <Form.Button onClick={submitTelegramSettings}>保存 Telegram 登录设置</Form.Button>
          <Divider />
          <Header as="h3" inverted={isDark}>
            配置 Turnstile
            <Header.Subheader>
          ...
          <Form.Button onClick={submitTurnstile}>保存 Turnstile 设置</Form.Button>
        </Form>
      </Grid.Column>
    </Grid>
  );
