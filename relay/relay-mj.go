	...
	defer func(ctx context.Context) {
		if mjResp.StatusCode == 200 && mjResp.Response.Code == 1 {
			...
			if quota != 0 {
				...
				model.RecordConsumeLog(ctx, userId, channelId, 0, 0, modelName, tokenName, quota, logContent, tokenId, userQuota, 0, false, other, c.ClientIP(), c.GetString(common.RequestIdKey), tokenGroup)
