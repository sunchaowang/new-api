...
func InitOptionMap() {
	...
	common.OptionMap["TopUpRate"] = strconv.FormatFloat(setting.TopUpRate, 'f', -1, 64)
	...
	common.OptionMap["HiddenGroups"] = setting.HiddenGroups2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "TopUpRate":
		setting.TopUpRate, _ = strconv.ParseFloat(value, 64)
	case "MinTopUp":
	...
	case "HiddenGroups":
		err = setting.UpdateHiddenGroupsByJSONString(value)
	...
	case "Manufacturers":
		err = setting.UpdateManufacturersByJSONString(value)
	}
	return err
}
